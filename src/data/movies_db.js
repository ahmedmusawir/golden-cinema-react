export const MovieActionData = [
  ...
  },
  {
    ...
    Director: 'Bryan Singer',
    Writer:
      'Tom DeSanto (story), Bryan Singer (story), David Hayter (screenplay)',
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BZmJkOGY4YjYtM2FmYy00MTIyLTg2YTUtMzJiNjljMWM5MGUwXkEyXkFqcGdeQXVyNjExODE1MDc@._V1_SX300.jpg',
    Ratings: [
      {
        Source: 'Internet Movie Database',
        Value: '7.4/10'
...
export const MovieComedy = [
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMTRhZTY0MDItY2I1Yi00MGE3LTk1ZDEtMjA0ZGZhNDQyNGU0XkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_SX300.jpg',
    Ratings: [
      {
        Source: 'Internet Movie Database',
        Value: '7.0/10'
    ...
    Website: 'http://www.facebook.com/austinpowersmovie',
    Response: 'True'
  },
  {
  ...
  },
  {
    ...
    Writer: 'Kevin Smith (characters), Kevin Smith',
    Actors: 'Jason Mewes, Kevin Smith, Ben Affleck, Jeff Anderson',
    Plot:
    ...
    Type: 'movie',
    DVD: '26 Feb 2002',
    BoxOffice: '$29,885,424',
    Production: 'Dimension Films',
    Website: 'http://newsaskew.com/va5',
    Response: 'True'
  },
  {
    ...
    Director: 'Frank Oz',
    Writer:
      'Alvin Sargent (story), Laura Ziskin (story), Tom Schulman (screenplay)',
    ...
    Poster:
      'https://ia.media-imdb.com/images/M/MV5BMTQxMjU2ODk4N15BMl5BanBnXkFtZTgwODQzNTcxMTE@._V1_SX300.jpg',
    Ratings: [
      {
        Source: 'Internet Movie Database',
        Value: '7.0/10'
